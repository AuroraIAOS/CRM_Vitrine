...
**Etapa 03 em curso — fechamento do MVP odontológico.** Entre as Etapas 02 e 03 correu um benchmark de 8 concorrentes (5 brasileiros, incluindo os 3 mais vendidos do país) e um dossiê de UX com três versões completas: `design/benchmark/` e `design/ux/`. Dali saíram os **24 itens do MVP odontológico** e o roteiro de sete etapas que Max fixou em 2026-09-02. **Hoje são 30 itens:** dois acrescentados por Max em 2026-09-03 (Resumo do paciente e Prescrições de medicamento) e quatro em 2026-09-04, vindos da pesquisa `analise-ice` sobre o ICE Health System — opções de tratamento concorrentes, requisitos por procedimento, recusa implícita de tratamento e vigência de tabela de preço. A Etapa 03 cobre as quatro primeiras etapas do roteiro — uniformidade, os 30 itens, a UX e o portão adversarial — em **30 subetapas**, planejadas na Subetapa 03.0, revisadas na 03.0.a e detalhadas em `docs/00_PLANO_E_CRITERIOS.md`. Recorte enxuto só da Etapa 03, com tabela de progresso, em `docs/00a_PLANO_ETAPA_03.md` — cópia sincronizada a cada subetapa, docs/00 continua sendo a fonte canônica.

Próximo passo: **Subetapa 03.6.a** (catálogo: regra do código e requisitos por procedimento), primeiro elo da corrente obrigatória `03.6.a → 03.7.a → 03.8 → 03.8.a`. Roteiro completo em `docs/00_PLANO_E_CRITERIOS.md` (recorte rápido em `docs/00a_PLANO_ETAPA_03.md`). Dicas técnicas e armadilhas conhecidas em `handoffs/instrucoes.md`. Parecer da pesquisa `analise-ice` em `design/benchmark/RELATORIO_DE_IMPACTO_ICE.md`. Backlog comercial das Etapas 5 e 6 em `docs/07_BACKLOG_COMERCIAL.md`. Histórico de versões em `CHANGELOG.md`.
