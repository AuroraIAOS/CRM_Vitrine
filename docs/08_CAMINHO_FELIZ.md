...
| **E5** Contrato | recusa implícita da opção perdedora (03.8); **contrato cópia fiel da opção, documento com hash, assinatura do profissional derivada da aprovação, assinatura presencial do paciente, e a execução liberada só com as duas (03.8.b)**; **token externo (03.10) e assinatura do paciente pelo celular, por QR code ou link copiado, com data de nascimento, desenho e hash do texto, alimentando o mesmo estado `assinado` (03.12)** | disparo do link por WhatsApp, SMS ou e-mail e a "via registrada" do passo 25 → **sem dono** (pendência vigiada de 2026-09-16) |
| **E6** Execução | agenda; **faces executadas com data e autor gravados pelo banco, e nenhuma execução sem contrato assinado ou dispensa do owner (03.8.b)**; **evolução escrita durante a sessão com intercorrência em lugar próprio, e a recusa do paciente em assinar registrada com data e autor (03.7.b)**; **aceite do paciente na evolução pelo celular, exclusivo com a recusa (03.12 — no consultório, pelo QR no celular dele)** | prescrição → **03.16.a** |
