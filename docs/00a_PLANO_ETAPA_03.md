...
| 03.21.1 | Análise e distribuição de acessos: quem vê o quê, em tudo | Onda 5 · P-sub | Opus | ⬜ não iniciada |
...
Qualidade — **quatro travas, e a primeira é a que decide se a subetapa vale alguma coisa:**
  ...
  4. **A distribuição fina de acesso é da Subetapa 03.21.1, não desta.** A separação "dentista não vigia o financeiro" é nova em natureza — até aqui o produto separava por módulo e por alcance clínico, e nunca precisou esconder o financeiro de quem tem alcance clínico. Aqui as abas nascem com a permissão que o módulo já tem e **nenhum mecanismo de permissão é inventado**; a 03.21.1 varre tudo e decide. O que esta subetapa não pode fazer é o oposto: entregar aba clínica alcançável por quem o banco não autoriza, contando com a 03.21.1 para consertar depois.
...
### Subetapa 03.21.1 — Análise e distribuição de acessos: quem vê o quê, em tudo [Goal] [Manual] [LLM: Opus] · P-sub
...
(… 03.n conforme necessário. Subetapa nova de escopo entra **antes da 03.23**, para que o portão adversarial continue sendo o último passo da Etapa. O sufixo de letra — 03.7.a, por exemplo — é o padrão para inserir subetapa sem renumerar as seguintes, que já estarão referenciadas em commits e em entradas de `handoffs/instrucoes.md`. **Sufixo numérico também está em uso**, por nomeação direta de Max em 2026-09-03: a `03.21.1`. As duas formas convivem e significam a mesma coisa — inserção sem renumeração —, e isto fica escrito para que uma sessão futura não conclua que a convenção foi quebrada em silêncio.)
