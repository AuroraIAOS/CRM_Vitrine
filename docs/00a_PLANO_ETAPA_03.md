...
Objetivo geral: implantar os **26** itens do MVP — os 24 levantados pelo benchmark (`design/benchmark/RELATORIO.md` §5 c, revisado por Max em 2026-09-02) mais os **dois acrescentados por Max em 2026-09-03**, Resumo do paciente e Prescrições de medicamento, escolher e implantar a UX, e passar pelo portão adversarial — sobre o produto já lançado, sem reconstruir nada do v01.
...
## ETAPA 03 · ETAPA 2 DO ROTEIRO — OS 26 ITENS DO MVP
